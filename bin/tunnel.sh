...
if [ $# -eq 0 ]; then
    sudo sshuttle --method tproxy -e 'ssh -i /home/ds/.ssh/id_ed25519_ds_cs' -r ds@secure.cryptostruct.com -x 10.0.0.0/16 10.0.0.0/8 57.128.202.29/32 89.58.50.26/32
    exit 0
fi
